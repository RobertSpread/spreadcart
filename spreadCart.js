        ...
        jQuery.each( basketData.orderListItems, function(index ){
            ...
            if(cart.strings.deleteItem) {
                ...
                jQuery('#updateQuantity-'+index).on("click",function() {
                    cart.updateItem(basketData.orderListItems[index].apiId,parseInt(jQuery('#newQuantity-'+index).val()),basketData.orderListItems[index].apiProductId,basketData.orderListItems[index].appearanceId,basketData.orderListItems[index].sizeId)
                });
            }
        });
