...
translations.shippingInformation="";
translations.vatInformation="";
...
function buildCustomMiniBasket(){
    ...
    jQuery('#miniBasketFooter').append('<div class="row"><div class="miniBasketLabel">'+translations.shippingTotal+'</div> <div class="miniBasketLabel miniBasketPrice" id="priceShipping">'+fixPrice(basketData.priceShipping)+'</div> </div>');
    jQuery('#miniBasketFooter').append(' <div class="row topLine total"> <div class="miniBasketLabel">'+translations.total+'</div> <div class="miniBasketLabel miniBasketPrice" id="priceTotal">'+fixPrice(basketData.priceTotal)+'</div> </div><div class="Price" itemscope="null" itemtype="http://schema.org/Offer" itemprop="offers"><div class="Item vat customLink">inkl. MwSt. EU</div> <div class="Item shipping customLink">inkl. Versand</div><meta content="http://schema.org/InStock" itemprop="availability"></div></div>');
...
//function to update the item total and the cart total after an basket item is deleted. Requires totals to be handed over from delete function. function itself does not calculate the totals but updates them
function updateTotal(newTotal,newItemTotal){
    jQuery('#priceTotal').html(fixPrice(newTotal));
